...
public class HopTests extends TestCase {

    @Test
    public void simpleSingleHopTest() {
        // @formatter:off
    ...
    @Test
    public void hopWithSameFromAndToTest() {
        // @formatter:off
        JavaFileObject source = JavaFileObjects.forSourceString("test.SimpleFSM", Joiner.on('\n').join(
            "package test;",
            "import com.github.shiraji.kenkenpa.annotations.Hop;",
    ...
    @Test
    public void hopMethodWithParameter() {
        // @formatter:off
        JavaFileObject source = JavaFileObjects.forSourceString("test.SimpleFSM", Joiner.on('\n').join(
            "package test;",
            "import com.github.shiraji.kenkenpa.annotations.Hop;",
    ...
    @Test
    public void hopMethodWithReturnValue() {
        // @formatter:off
        JavaFileObject source = JavaFileObjects.forSourceString("test.SimpleFSM", Joiner.on('\n').join(
            "package test;",
            "import com.github.shiraji.kenkenpa.annotations.Hop;",
        ...
        JavaFileObject expectedSource = JavaFileObjects.forSourceString("test.KenKenPa_SimpleFSM", Joiner.on('\n').join(
            ...
            "      to = \"CIRCLE2\"",
            "  )",
            "  public final String fire(int i) {",
            "    String newState = takeOff$$fire();",
            "    java.lang.String returnValue = super.fire(i);",
            "    land$$fire(newState);",
            "    $$mCurrentState$$ = newState;",
            "    return returnValue;",
            "  }",
